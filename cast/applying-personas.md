...
2. **Brainstorm possible personas** — start broad, then combine through
   ...
   has the final say.
3. **Brainstorm persona goals** — between two and six goals per persona,
   representing what the persona wants to achieve through the system. "A persona
...
5. **Brainstorm persona scenarios** — describe interactions, not tasks: how a
   ...
   scenario.
6. **Select the primary persona** — the one who *must* be satisfied but cannot be
...
the primary persona, estimated); persona goals and scenarios feed `spec/` — a
...
Stories" (2001); Cooper & Reimann, *About Face* (2003); Agile Alliance — BDD.
